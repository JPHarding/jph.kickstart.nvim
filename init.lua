...
-- JP's Default fall back indentation
vim.o.tabstop = 4
vim.o.shiftwidth = 4
  ...
  -- LSP Plugins
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        prettierd = {},
        prettier = {},
        -- pint = {}, Nice PHP formatter. although the lsp (inetephense) is better.
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        -- php = { 'pint' }, -- https://laravel.com/docs/12.x/pint -- Nice PHP formatter. although the lsp (inetephense) is better.
      },
    },
  },
